  ...
  FilthyPillow.prototype = {
    template: '<div class="fp-container">' +
                '<div class="fp-calendar">' +
                    '<span class="fp-month fp-option"></span>/' +
                        '<span class="fp-day fp-option"></span>/' +
                            '<span class="fp-year fp-option"></span>' +
                '</div>' +
                '<div class="fp-clock">' +
                  '<span class="fp-hour fp-option"></span>:<span class="fp-minute fp-option"></span>' +
                  '<span class="fp-meridiem fp-option"></span>' +
                '</div>' +
                '<div class="fp-save"><button class="btn btn-primary fp-save-button">ОК</button></div>' +
...
//        }
      ...
      if( step !== 'year' && this.currentDigit === 2 )
        moveNext = true;
      else if (step === 'year' && this.currentDigit == 4 )
        moveNext = true;
        ...
        moveNext = true;
//        else if (step === 'year' && digit === 1 && value !== 2) {
//          fakeValue = precedingDigit;
//          moveNext = true;
//      }

//        console.log(moveNext, this.currentDigit, fakeValue, step);
    ...
    onKeyUp: function( e ) {
      ...
      if( (this.currentStep !== 'year' && this.currentDigit === 2) || (this.currentStep === 'year' && this.currentDigit === 4) )
        this.currentDigit = 0;
    },
